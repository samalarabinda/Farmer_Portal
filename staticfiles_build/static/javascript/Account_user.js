document.addEventListener('DOMContentLoaded', function () {
    const districtInput = document.getElementById("place");
    const districtList = document.getElementById("districtList");
    const districts = ["Angul", "Boudh", "Balangir", "Bargarh", "Baleswar", "Bhadrak", "Cuttack", "Deogarh","Dhenkanal","Ganjam","Gajapati",
    "Jharsuguda","Jaipur","Jagatsinghapur","Khordha","Keonjhar","kalahandi","Kandhamal","koraput","Kendrapara","Malkangiri","Mayurbhanj",
    ...
    //block javascript for drop down
    const blockInput = document.getElementById("block");
    const blockList = document.getElementById("blockList");
    const blocks = ["Cuttack Sadar","Baranga","Kantapada","Niali","Tangi-Chowdwar","Salipur","Nischintakoili","Mahanga"," Athgarh","Tigiria",
    ...
    blockInput.addEventListener("input", function () {
        const searchQuery = blockInput.value.toLowerCase();
        const filteredblocks = blocks.filter(block =>
            block.toLowerCase().includes(searchQuery)
        );

        renderblocks(filteredblocks);
    });

    function renderblocks(filteredblocks) {
        blockList.innerHTML = "";

        filteredblocks.forEach(blocks => {
            const blockItem = document.createElement("li");
            blockItem.textContent = blocks;
            blockItem.className = "block-item";

        blockItem.addEventListener("click", function () {
                blockInput.value = blocks;
                blockList.innerHTML = "";
            });
